...
public class Tela extends JFrame {
	...
	public Tela() {
		...
		textField_ra02 = new JTextField();
		textField_ra02.setColumns(10);
		textField_ra02.setBounds(82, 220, 86, 20);
		InserirGrupos.add(textField_ra02);
		...
		textField_ra03 = new JTextField();
		textField_ra03.setColumns(10);
		textField_ra03.setBounds(82, 261, 86, 20);
		InserirGrupos.add(textField_ra03);
		...
		textField_ra04 = new JTextField();
		textField_ra04.setColumns(10);
		textField_ra04.setBounds(82, 307, 86, 20);
		InserirGrupos.add(textField_ra04);
		...
		textField_ra01 = new JTextField();
		textField_ra01.setColumns(10);
		textField_ra01.setBounds(82, 190, 86, 20);
		InserirGrupos.add(textField_ra01);
		...
		btnConsultarOrientacao.setBounds(418, 141, 134, 23);
		...
		btnultimaOrientacao.setBounds(418, 96, 134, 23);
		...
		lblNewLabel.setBounds(184, 193, 58, 17);
		InserirGrupos.add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel("Nome:");
		lblNewLabel_1.setFont(new Font("Tahoma", Font.PLAIN, 14));
		lblNewLabel_1.setBounds(184, 223, 58, 17);
		InserirGrupos.add(lblNewLabel_1);
		
		JLabel lblNewLabel_2 = new JLabel("Nome:");
		lblNewLabel_2.setFont(new Font("Tahoma", Font.PLAIN, 14));
		lblNewLabel_2.setBounds(184, 261, 58, 17);
		InserirGrupos.add(lblNewLabel_2);
		
		JLabel lblNewLabel_3 = new JLabel("Nome:");
		lblNewLabel_3.setFont(new Font("Tahoma", Font.PLAIN, 14));
		lblNewLabel_3.setBounds(184, 310, 58, 17);
		InserirGrupos.add(lblNewLabel_3);
		
		textGruponome1 = new JTextField();
		textGruponome1.setBounds(232, 190, 147, 20);
		InserirGrupos.add(textGruponome1);
		textGruponome1.setColumns(10);
		
		textGruponome2 = new JTextField();
		textGruponome2.setBounds(232, 220, 147, 20);
		InserirGrupos.add(textGruponome2);
		textGruponome2.setColumns(10);
		
		textGruponome3 = new JTextField();
		textGruponome3.setColumns(10);
		textGruponome3.setBounds(232, 261, 147, 20);
		InserirGrupos.add(textGruponome3);
		
		textGruponome4 = new JTextField();
		textGruponome4.setColumns(10);
		textGruponome4.setBounds(232, 307, 147, 20);
		InserirGrupos.add(textGruponome4);
		
		AlunosController Vcont= new AlunosController(textFieldNome, textFieldRa);
		
		ControllerSubGP CsCont1= new ControllerSubGP (textFieldSubarea,  textAreaCS,  textFieldNOMEGP, textFieldCodgpCp);
		btnPesquisarSUB.addActionListener(CsCont1);
		...
		ConsultaCorntoller CC = new ConsultaCorntoller(textFieldCodgpCp, textAreaCG );
		GruposController GC = new GruposController(textFieldNOMEGP,  textFieldTEMAGP, textFieldAREA, textFieldSUBAREA,  textFieldDATA, textFieldCOD, textField_ra01, textField_ra02,  textField_ra03,  textField_ra04,textGruponome1, textGruponome2,textGruponome3,textGruponome4 );
		btnCodGerar.addActionListener(GC);
		CosultaOrientacao CCont= new CosultaOrientacao (textFieldCodigoOrientacao, textAreaConsultaOrientacao);
		btnConsultarOrientacao.addActionListener(CCont);
		btncadastrar.addActionListener(Vcont);
		btnPesquisar.addActionListener(CC);
		btnCadastrarOrientacao.addActionListener(Ocontroller);
		btnultimaOrientacao.addActionListener(CCont);
	}
}
